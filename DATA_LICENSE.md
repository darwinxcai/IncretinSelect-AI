...
The training workbook, prospective P1–P15 workbooks, and derived tables originate
...
| `data/derived/external_predictions_locked.csv` | Label-independent predictions for the 15 published designs | CC BY 4.0 attribution to the experimental source |
| `data/derived/external_dependency_groups.csv` | Label-free sequence-dependence assignments for P1–P15 | CC BY 4.0 attribution to the experimental source |
| `reports/external_prediction_receipt.json` | Pre-score provenance, hashes, and label-free prediction metadata | CC BY 4.0 attribution to the experimental source |
...
| `src/incretinselect/assets/incretin_ridge_v1.json` | Frozen transformed model parameters and label-free aligned reference sequences used for local inference | CC BY 4.0 attribution to the experimental source |
